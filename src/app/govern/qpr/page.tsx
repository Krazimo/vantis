  ...
  return (
    <div className="px-4 sm:px-6 py-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="font-syne text-2xl sm:text-3xl text-foreground">QPR Compliance Tracker</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
        <div className="bg-card border border-border rounded-sm p-4 text-center">
          <div className="font-syne text-3xl font-bold text-foreground">{CURRENT_STATS.dueCount}</div>
        ...
        <div className="bg-card border border-status-compliant/20 rounded-sm p-4 text-center">
          <div className="font-syne text-3xl font-bold text-status-compliant">{CURRENT_STATS.onTimeCount}</div>
        ...
        <div className="bg-card border border-status-risk/20 rounded-sm p-4 text-center">
          <div className="font-syne text-3xl font-bold text-status-risk">{CURRENT_STATS.defaultingCount}</div>
      ...
      {totalPenalty > 0 && (
        <div className="bg-status-risk/5 border border-status-risk/20 rounded-sm p-4 mb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <div className="font-syne text-2xl font-bold text-status-risk">{fmtInr(totalPenalty)}</div>
          </div>
