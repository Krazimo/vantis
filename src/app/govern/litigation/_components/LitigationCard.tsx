...
export default function LitigationCard({ item: l }: Props) {
  ...
  return (
    <div className={`bg-surface border border-border rounded-sm overflow-hidden ${leftBorder(l)}`}>
      <div className="px-4 py-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div><div className="text-[10px] text-gray uppercase tracking-wide mb-0.5">Court</div><div className="text-off-white text-xs leading-snug">{l.court}</div></div>
          <div>
          ...
          <div><div className="text-[10px] text-gray uppercase tracking-wide mb-0.5">Survey Nos.</div><div className="font-mono text-off-white text-xs">{survey}</div></div>
          {l.relief_sought_crore && (
            <div><div className="text-[10px] text-gray uppercase tracking-wide mb-0.5">Relief Sought</div><div className="font-mono text-red text-xs font-bold">₹{l.relief_sought_crore} Cr</div></div>
          )}
        </div>
        ...
        <div className="flex flex-wrap gap-4 mt-3 pt-3 border-t border-border">
          <div className="flex items-center gap-1.5 text-xs text-gray">
            ...
            Filed {fmtDate(l.filed_date)} <span className="text-gray-light">({since} days ago)</span>
          </div>
