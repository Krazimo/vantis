  ...
  if (projectId !== 'ozone-urbana') {
    return (
      <div className="bg-muted border border-border rounded-sm p-8 text-center">
        ...
        <div className="text-foreground text-sm font-medium mb-2">Insufficient Data for Prediction</div>
        <div className="text-muted-foreground text-xs max-w-sm mx-auto leading-relaxed mb-5">
        ...
        <div className="border border-border rounded-sm p-4 text-left max-w-md mx-auto">
          <div className="text-[10px] text-muted-foreground uppercase tracking-widest font-semibold mb-2">Ozone Urbana — Case Study</div>
          ...
          <Link href="/govern/projects/ozone-urbana" className="inline-flex items-center gap-1 text-primary text-xs mt-3 hover:text-primary/80 transition-colors duration-150">
