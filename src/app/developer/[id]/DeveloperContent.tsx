    ...
    <main className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 px-5 sm:px-8 py-6 max-w-3xl mx-auto w-full">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <h1 className="font-syne text-xl sm:text-2xl text-foreground">{dev.name}</h1>
              </div>
        ...
        <div className="grid grid-cols-4 gap-3 mb-5">
          {[dev.total_projects, dev.active_projects, dev.completed_projects, (dev.total_units ?? 0).toLocaleString('en-IN')].map((v, i) => (
            <div key={i} className="bg-card border border-border rounded-sm p-3 text-center">
              <div className="font-syne text-xl font-bold text-foreground">{v}</div>
        ...
        <div className="bg-card border border-border rounded-sm p-5 mb-5">
          <div className="font-mono text-[10px] uppercase tracking-[0.15em] text-muted-foreground mb-4">{tx.compliance}</div>
        ...
        <div className="mb-6">
          <h2 className="font-mono text-[10px] text-muted-foreground uppercase tracking-[0.15em] mb-3">{tx.projects}</h2>
        ...
        <div className="bg-card border border-primary/20 rounded-sm p-5 text-center">
          ...
          <div className="font-syne text-base text-foreground mb-1">{tx.cta}</div>
