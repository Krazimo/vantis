    ...
    <main className="min-h-screen bg-background flex flex-col">
      <header className="flex items-center justify-between px-5 sm:px-10 py-4 border-b border-border">
        <div className="flex items-center gap-2.5">
          ...
          <span className="hidden sm:inline text-gray text-[10px] font-mono uppercase tracking-[0.15em] ml-2 border-l border-border pl-3">by Orianode</span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <a href="/govern" className="flex items-center gap-1.5 text-xs text-gray-light hover:text-gold transition-colors duration-150">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-5 pt-16 pb-12">
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="font-mono text-[10px] text-gold-dim uppercase tracking-[0.2em]">{tx.tagline}</span>
        </div>
        <h1 className="font-syne text-3xl sm:text-5xl text-off-white text-center leading-tight mb-4 whitespace-pre-line">{tx.heading}</h1>
        <p className="text-gray text-sm sm:text-base text-center max-w-md mb-10 leading-relaxed">{tx.sub}</p>
        ...
        <div className="flex items-center gap-3 mt-8">
          ...
          <span className="font-mono text-[10px] text-gray uppercase tracking-[0.15em]">K-RERA · Kaveri 2.0 · eCourts · Bhoomi</span>
          <div className="h-px w-8 bg-border" />
        </div>
      </section>
