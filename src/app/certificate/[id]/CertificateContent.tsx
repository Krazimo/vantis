        ...
        <div className="bg-white border border-[#E2DDD4] rounded-sm overflow-hidden">
          ...
          <div className="px-6 py-6">
            <div className="text-center mb-6">
              ...
              <div className="font-mono text-gold text-xs sm:text-sm tracking-wide break-all mb-1">{cert.rera}</div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-5">
              <div><div className="text-[#6B6B88] text-[10px] uppercase tracking-widest font-semibold mb-1">Certificate ID</div><div className="font-mono text-gold text-xs break-all leading-relaxed">{cert.id}</div></div>
